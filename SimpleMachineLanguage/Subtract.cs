namespace SVM.SimpleMachineLanguage
{
    ...
    #endregion
    /// <summary>
    /// Implements the SML Subtract instruction
    /// Retrieves two integer values from the top of the
    /// stack and subtracts the first from the second, leaving
    /// the result on the stack
    /// </summary>
    public class Subtract: BaseInstructionOperands
    {
        #region Constants
        #endregion
        ...
        public override void Run()
        {
            try
            {
                ...
                VirtualMachine.Stack.Push(op2 - op1);
            }
