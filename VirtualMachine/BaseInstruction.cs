namespace SVM.VirtualMachine
{
    ...
    /// </summary>
    public abstract class BaseInstructionOperands: IInstruction
    {
        #region Constants
        protected const string StackUnderflowMessage = "A stack underflow error has occurred. ( at [line {0}])";
        protected const string OperandOfWrongTypeMessage = "The operand on the stack is of the wrong type. (at [line {0}])";
        ...
        public IVirtualMachine VirtualMachine
        {
            ...
            set
            {
                virtualMachine = value ?? throw new SvmRuntimeException(VirtualMachineErrorMessage);
            }
        }
        #endregion
    }
